#ifndef CYCAMORE_SRC_DYNAMICPOWERREACTOR_H_
#define CYCAMORE_SRC_DYNAMICPOWERREACTOR_H_
...
class DynamicPowerReactor : public cyclus::Facility,
  public cyclus::toolkit::CommodityProducer,
  public cyclus::toolkit::Position {
#pragma cyclus note { \
"niche": "dynamicpowerreactor", \
"doc": \
  "DynamicPowerReactor is a simple, general reactor based on static compositional" \
  " transformations to model fuel burnup.  The user specifies a set of input" \
  " fuels and corresponding burnt compositions that fuel is transformed to when" \
  " it is discharged from the core.  No incremental transmutation takes place." \
  " Rather, at the end of an operational cycle, the batch being discharged from" \
 ...
 public:
  DynamicPowerReactor(cyclus::Context* ctx);
  virtual ~DynamicPowerReactor(){};
 ...
 private:
  ...
  #pragma cyclus var { \
    "default": [], \
    "uilabel": "Percent power list", \
    "doc": "The percentage of the power level at which the reactor operates" \
           "in decimal form. If the timestep is outside the list provided, " \
           "power_cap will be used. If nothing is provided, power will " \
           "default to power_cap. For example, 75 percent should be input " \
           "as 0.75 in the list." \
  }
  std::vector<double> power_percent_list;
 ...
 //////////// inventory and core params ////////////
  ...
  #pragma cyclus var { \
    "default": 0, \
    "doc": "Number of time steps the reactor has operated.", \
    "uilabel": "Time Since Building This Facility", \
    "units": "time steps", \
  }
  int reactor_life;
...
#endif  // CYCAMORE_SRC_DYNAMICPOWERREACTOR_H_
