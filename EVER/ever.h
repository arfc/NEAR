#ifndef CYCAMORE_SRC_EVER_H_
#define CYCAMORE_SRC_EVER_H_
...
/// Ever is a simple, general reactor based on static compositional
...
class Ever : public cyclus::Facility,
...
///////////// recipe updates ///////////
  #pragma cyclus var { \
    "default": [], \
    "uilabel": "Time to Update Fresh/Spent Fuel Recipe", \
    "doc": "A time step on which to update the input-output recipe pair for " \
           "the requested fresh fuel.", \
  }
  std::vector<int> recipe_update_times;

  #pragma cyclus var { \
    "default": [], \
    "uilabel": "Commodity for Updated Fresh/Spent Fuel Recipe", \
    "doc": "The input commodity indicating fresh fuel for which recipes will " \
           "be changed. Same order as and direct correspondence to the " \
  ...
  #pragma cyclus var { \
    "default": [], \
    "uilabel": "New Recipes for Fresh Fuel", \
    "doc": "The new input recipes to use for each recipe update." \
           " Same order as and direct correspondence to the specified recipe " \
           "change times.", \
    "uitype": ["oneormore", "inrecipe"], \
  }
  std::vector<std::string> recipe_update_in;

  #pragma cyclus var { \
    "default": [], \
    "uilabel": "New Recipes for Spent Fuel", \
    "doc": "The new output recipes to use for each recipe update." \
           " Same order as and direct correspondence to the specified recipe " \
           "change times.", \
    "uitype": ["oneormore", "outrecipe"], \
  }
